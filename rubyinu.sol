...
/**
    Website : https://rubyinu.com

    #Ruby Inu Token Fetaures
	Total fees 5%
        3% fees on transaction and auto distributed to all token holder.
        2% burn from each transaction
...
contract Rubyinu_Token is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 10000000 *10**18; // 100 Quadrillion
    ...
    uint256 public _taxFee = 300; // 100 = 3% Static Rewards
    uint256 public _charityFee = 200; // 100 = 2% Burn
    
    uint256 public _taxFeeTotal;
    uint256 public _charityFeeTotal;
    
    address public charityAddress = 0x000000000000000000000000000000000000dEaD; // Burn Address
