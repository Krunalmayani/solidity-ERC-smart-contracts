...
contract DogeDash is IERC20, Ownable {
    ...
    event BurnTransfer(address indexed from, address indexed to, uint256 value);
    event MarketingTransfer(address indexed from, address indexed to, uint256 value);
    ...
    function _takeMarketingAndBurnToken(uint256 tMarketingAndBurn, address sender) private { //6000
        if(_marketingFee + _burnFee > 0){
            ...
            emit BurnTransfer(sender, burnWallet, tBurn);
            ...
            emit MarketingTransfer(sender, marketingWallet, tMarketing);
        }
    }
